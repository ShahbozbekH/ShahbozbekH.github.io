  ...
  html.div([attribute.class("mx-auto max-w-3xl")], [
    ...
    html.main([attribute.class("my-16")], {
      ...
      html.div([attribute.class("")], [
       html.div([attribute.class("absolute top-[2.5px] left-[320.15px] invisible xl:visible")], [html.text("𐰼")]),
          ...
          html.div([attribute.class("absolute top-[518px] left-[191px] rotate-[45deg] text-3xl invisible xl:visible")], [
            ...
            html.div([attribute.class("relative bottom-[147px] right-[22px] rotate-[270deg]")],[html.text("𐰼")]),
          ]), 
          html.div([attribute.class("absolute top-[518px] left-[334px] rotate-[45deg] text-3xl invisible xl:visible")], [
            html.text("𐰬"),
            html.div([attribute.class("relative bottom-[56.5px] left-[5px]")],[html.text("𐰼")]),   
            html.div([attribute.class("relative bottom-[50px] right-[5px] rotate-[180deg]")],[html.text("𐰼")]), 
            html.div([attribute.class("relative bottom-[101.5px] left-[22px] rotate-[90deg]")],[html.text("𐰼")]),
            html.div([attribute.class("relative bottom-[147px] right-[22px] rotate-[270deg]")],[html.text("𐰼")]),
          ]), 
      ...
      html.div([attribute.class("")], [
          ...
          html.div([attribute.class("absolute top-[75px] right-[280px] invisible font-bold invisible xl:visible")],[
              html.div([attribute.class("relative left-[1px] top-[26.5px] text-[0.5rem]")], [html.text("")]),
              html.div([attribute.class("relative text-xl font-bold -scale-x-100")], [html.text("𐰐")]),
              html.div([attribute.class("relative -right-[11px] -top-[17px] rotate-[90deg] text-xl font-bold -scale-x-100")], [html.text("𐰐")]),
              html.div([attribute.class("relative left-[0px] -top-[34px] rotate-[180deg] text-xl font-bold -scale-x-100")],  [html.text("𐰐")]),
              html.div([attribute.class("relative -left-[10.75px] -top-[73px] rotate-[270deg] text-xl font-bold -scale-x-100")], [html.text("𐰐")]),
          ]),
          html.div([attribute.class("absolute top-[75px] right-[360px] invisible font-bold invisible xl:visible")],[
              html.div([attribute.class("relative left-[1px] top-[26.5px] text-[0.5rem]")], [html.text("")]),
              html.div([attribute.class("relative text-xl font-bold transform -scale-x-100")], [html.text("𐰐")]),
              html.div([attribute.class("relative -right-[11px] -top-[17px] rotate-[90deg] text-xl font-bold -scale-x-100 ")], [html.text("𐰐")]),
              html.div([attribute.class("relative left-[0px] -top-[34px] rotate-[180deg] text-xl font-bold -scale-x-100")],  [html.text("𐰐")]),
              html.div([attribute.class("relative -left-[10.75px] -top-[73px] rotate-[270deg] text-xl font-bold -scale-x-100")], [html.text("𐰐")]),
          ]),
          html.div([attribute.class("absolute top-[400px] right-[400px] invisible xl:visible")],
                  [html.div([attribute.class("relative rotate-[82deg] font-bold text-[1.0rem] bottom-[6px] right-[6.5px] ")],[html.text("𐰡")]),
                  html.div([attribute.class("relative text-[1.50rem] bottom-[45px] left-[1px] rotate-[40deg]")],[html.text("𐰐")]),
                  html.div([attribute.class("relative text-[1.0rem] font-bold bottom-[68px] right-[17px] -rotate-[88deg]")],[html.text("𐰡")]),
                  html.div([attribute.class("relative text-[0.5rem] bottom-[93px] left-[6px] rotate-[84deg]")],[html.text("𐰨")]),
                  html.div([attribute.class("relative text-[0.4rem] bottom-[103px] left-[5px] rotate-[40deg]")],[html.text("𐰨")]),
                  html.div([attribute.class("relative text-[0.4rem] bottom-[110px] left-[3px] rotate-[40deg]")],[html.text("𐰨")]),
                  html.div([attribute.class("relative text-[0.9rem] bottom-[125px] right-[25px] -rotate-[90deg]")],[html.text("𐰽")]),
                  html.div([attribute.class("relative text-[0.8rem] bottom-[136px] right-[20px] -scale-x-100 scale-y-75")],[html.text("𐰒")]),
                  html.div([attribute.class("relative text-[0.8rem] bottom-[155.5px] right-[8px] -scale-x-100 scale-y-75")],[html.text("𐰒")]),
                  html.div([attribute.class("relative text-[0.3rem] bottom-[173.5px] right-[6.5px] ")],[html.text("𐱇")]),
                  ]),
          ...
          html.div([attribute.class("absolute top-[518px] right-[289px] rotate-[45deg] text-3xl invisible xl:visible")], [
            html.text("𐰬"),
            html.div([attribute.class("relative bottom-[56.5px] left-[5px]")],[html.text("𐰼")]),   
            html.div([attribute.class("relative bottom-[50px] right-[5px] rotate-[180deg]")],[html.text("𐰼")]), 
            html.div([attribute.class("relative bottom-[101.5px] left-[22px] rotate-[90deg]")],[html.text("𐰼")]),
